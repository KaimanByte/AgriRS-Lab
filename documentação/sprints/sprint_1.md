...
|----|--------------------|------------|-------------|----------|------------|
| **DD-001** | Definir cores, tipografia, espaçamento e estilos de botões | 8 | DD | 1 | RNF06 |
| **DD-002** | Criar header e footer padrão (Figma) | 5 | DD | 1 | RNF06 |
| **DD-003** | Criar guia de estilo | 8 | DD | 1 | RNF06 |
| **DD-004** | Criar layout no Figma (Home) | 13 | DD | 1 | RF01 |
| **DD-005** | Criar layout no Figma (Sobre) | 8 | DD | 1 | RF02 |
| **DD-006** | Criar layout no Figma (Membros) | 8 | DD | 1 | RF03 |
| **DD-007** | Criar layout no Figma (Vagas) | 20 | DD | 1 | RF04 |
| **DD-008** | Criar layout no Figma (Projetos) | 13 | DD | 1 | RF05 |
| **DD-009** | Criar layout no Figma (Notícias) | 13 | DD | 1 | RF06 |
| **DD-010** | Criar layout no Figma (Publicações) | 8 | DD | 1 | RF07 |
| **DD-011** | Criar layout no Figma (Contato) | 8 | DD | 1 | RF08 |
| **DW-001** | Criar arquivo HTML (Home) | 5 | DW | 1 | RF01 |
| **DW-002** | Aplicar design CSS (Home) | 8 | DW | 1 | RF01 |
| **DW-004** | Inserir links para redes sociais e contato | 5 | DW | 1 | - |
| **DW-005** | Criar arquivo HTML (Sobre) | 5 | DW | 1 | RF02 |
| **DW-006** | Aplicar design CSS (Sobre) | 8 | DW | 1 | RF02 |
| **DW-007** | Inserir textos e imagens do laboratório | 8 | DW | 1 | - |
| **DW-008** | Criar arquivo HTML (Membros) | 5 | DW | 1 | RF03 |
| **DW-009** | Aplicar design CSS (Membros) | 8 | DW | 1 | RF03 |
| **DW-010** | Inserir imagens e textos | 8 | DW | 1 | - |
| **DW-011** | Criar arquivo HTML (Vagas) | 5 | DW | 1 | RF04 |
| **DW-012** | Aplicar design CSS (Vagas) | 8 | DW | 1 | RF04 |
| **DW-013** | Inserir informações sobre candidaturas | 5 | DW | 1 | RF04 |
| **DW-014** | Criar arquivo HTML (Projetos) | 5 | DW | 1 | RF05 |
| **DW-015** | Aplicar design CSS (Projetos) | 8 | DW | 1 | RF05 |
| **DW-016** | Inserir imagens e links adicionais | 5 | DW | 1 | - |
| **DW-017** | Criar arquivo HTML (Notícias) | 8 | DW | 1 | RF06 |
| **DW-018** | Aplicar design CSS (Notícias) | 8 | DW | 1 | RF06 |
| **DW-020** | Criar arquivo HTML (Publicações) | 5 | DW | 1 | RF07 |
| **DW-021** | Aplicar design CSS (Publicações) | 8 | DW | 1 | RF07 |
| **DW-022** | Criar arquivo HTML (Contato) | 5 | DW | 1 | RF08 |
| **DW-023** | Aplicar design CSS (Contato) | 8 | DW | 1 | RF08 |
| **DW-024** | Inserir mapa do laboratório dentro do INPE | 13 | DW | 1 | - |
| **DW-027** | Criar header e footer padrão (HTML e CSS) | 13 | DW | 1 | RNF01 |
...
O início da sprint foi marcado por um período de adaptação à metodologia **Scrum**, o que gerou alguns desafios na organização e distribuição das atividades.  
Ao longo do processo, identificamos a necessidade de **estudos contínuos** para a execução de tarefas que exigiam conhecimentos ainda não dominados pela equipe.  

Com o engajamento e colaboração de todos, conseguimos superar essas dificuldades e aprimorar nossa dinâmica de trabalho.  
O resultado foi extremamente positivo: **todas as tasks foram concluídas com sucesso** e o **feedback do cliente foi bastante satisfatório**, reforçando o comprometimento e a evolução do time durante esta primeira sprint.
